...
$|\mathcal{T}| = 32$ & \multicolumn{3}{c}{\emph{[pending: see note]}} \\
\bottomrule
\end{tabular}
\end{table}
...
($\sigma \approx 0.03$--$0.05$) and inside the confidence intervals of both.
On this evidence, granularity does not matter.
